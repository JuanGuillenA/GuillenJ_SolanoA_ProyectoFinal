...
a persistence unit "citasPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "citas/pom.xml":
...
artifact ("citas.war") is already built. You can build
